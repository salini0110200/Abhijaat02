...
if ((event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "bot love u")) {
   ...
   if ((event.body.toLowerCase() == "@Dhoke baaz") || (event.body.toLowerCase() == "NK") || (event.body.toLowerCase() == "Khebda") || (event.body.toLowerCase() == "Dhokebaaz")) {
     return api.sendMessage( " boss Busy HoGa Work Me Yha Main t0o Hun Na https://www.facebook.com/julmijaat1008?mibextid=ZbWKwL😘",threadID);


   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:-☞𝑵𝑲 𝑬𝑫𝑰𝑻𝑶𝑹☜💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝑵𝑲\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞https://www.facebook.com/profile.php?id=61577417285926 \n👋For Any Kind Of Help Contact On Instagram Username 👉https://www.instagram.com/nk_lovely_143_1?igsh=OXY4eDBsbzEzMnVr  😇", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage(" ⓄⓌⓃⒺⓇ 𝑵𝑲 𝑬𝑫𝑻𝑶𝑹  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };
...
if ((event.body.toLowerCase() == "I love you") || (event.body.toLowerCase() == "Love you ")) {
  ...
  if ((event.body.toLowerCase() == "lob you") || (event.body.toLowerCase() == "i lob you")) {
   ...
   if ((event.body.toLowerCase() == "&fuck") || (event.body.toLowerCase() == "&Fuck")) {
     return api.sendMessage("🏔️🏝️𝑵𝑲 Ƞɛ ꌗƥɛçɪɑɭɭɣ Ƭuɱ 🌊🪺Jɑɪʂɛ Ƭɧɑɽƙɪɣɵ Ƙɛ Ɬɪɣɛ•• 🏞️🌬️Ɣɑɧ çɵɱɱɑƞɗ Ɦɑʈɑ Ɗɪɣɑ Ɦɑɪ↗↘ Sɵɽɽɣ Ɠɣuʂ••😹🫶", threadID);
   };

  if ((event.body.toLowerCase() == "ami. nk editor") || (event.body.toLowerCase() == "ami Dhoke baaz") || (event.body.toLowerCase() == "main nkbot") || (event.body.toLowerCase() == "main julmi") || (event.body.toLowerCase() == "main jaat")) {
